  ...
  return (
    <tr className='border-b hover:bg-gray-50'>
      ...
      <td className='p-3'>
        ...
        <p><span className='text-gray-800 uppercase font-bold'>Telf:</span>{telefono}</p>
      </td>
      ...
      <button
          type='button'
          className='bg-yellow-600 hover:bg-yellow-700 block w-full text-white p-2 uppercase
          font-bold text-xs'
